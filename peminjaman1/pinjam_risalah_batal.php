...
<div class="container">
    <div class="header">
        ...
        <form method="GET" class="search-form">
            ...
            <a href="pinjam_risalah_batal.php" class="reset-btn">Reset</a>
        </form>
        <div class="kembali">
    ...
    <form method="POST" action="proses_pinjam_batal.php">
