...
// Sanitasi ringan untuk string (hindari %_ injeksi liar di LIKE)
...
// --- Bangun query ---
$query = "SELECT * FROM risalah_tap WHERE 1=1";
...
if (isset($_GET['export']) && $_GET['export'] === 'excel') {
    ...
    header("Content-Disposition: attachment; filename=data_risalah_tap.xls");
...
<title>Cek Data Risalah TAP</title>
<style>
...
<div class="container">
    <div class="kembali">
        <a href="menu_risalah.php">Kembali</a>
    </div>

    <h2>Cek Data Risalah TAP</h2>

    <!-- FORM FILTER -->
    <form method="GET">
        <div class="filters">
            <input type="text" name="no_risalah" placeholder="No. register"       value="<?= htmlspecialchars($searchNo) ?>">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['status']) ?></td>
                        <td><a href="edit_risalah_tap.php?id=<?= (int)$row['id'] ?>" class="btn-edit">Edit</a></td>
                    </tr>
            <?php
                endwhile;
            endif; ?>
