...
$query = mysqli_query($conn, "SELECT * FROM risalah_batal WHERE id = '$id'");
...
if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($conn, "UPDATE risalah_batal SET 
        box = '$box',
        lemari = '$lemari'
        WHERE id = '$id'
    ");
    ...
    if ($update) {
        echo "<script>alert('Data berhasil diupdate!'); window.location='cek_data_batal.php';</script>";
    } else {
...
<title>Edit Data Risalah BATAL</title>
<style>
...
<body>
<div class="container">
    <h2>Edit Data Risalah BATAL (Hanya Box & Lemari)</h2>
    <form method="POST">
