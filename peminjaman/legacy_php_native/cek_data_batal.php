...
// Sanitasi ringan untuk string (hindari injeksi LIKE)
...
// --- Query ---
$query = "SELECT * FROM risalah_batal WHERE 1=1";
...
if (isset($_GET['export']) && $_GET['export'] === 'excel') {
    ...
    header("Content-Disposition: attachment; filename=data_risalah_batal.xls");
...
<title>Cek Data Risalah Batal</title>
<style>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['status']) ?></td>
                        <td><a href="edit_risalah_batal.php?id=<?= (int)$row['id'] ?>" class="btn-edit">Edit</a></td>
                    </tr>
            <?php
                endwhile;
            endif; ?>
